  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // close button stays pinned at the corner.
        "fixed left-[50%] top-[50%] z-50 flex flex-col w-[calc(100%-1rem)] max-w-lg max-h-[calc(100vh-1.5rem)] sm:max-h-[90vh] translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:rounded-lg overflow-hidden",
        className
      )}
      {...props}>
